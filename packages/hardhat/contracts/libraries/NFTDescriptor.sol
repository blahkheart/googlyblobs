...
library NFTDescriptor {
    ...
    function generateSVGImage(SVGParams memory _svgParams) internal pure returns (string memory svg) {
        bool isCyclopse = _svgParams.isCyclopse;
        if(isCyclopse) {
            return string(
                abi.encodePacked(
                    generateSVGHead(),
                    BodyDetail.buildBody(_svgParams.bodyId, _svgParams.bodyColor),
                    EyesDetail.buildCyclopseEye(_svgParams.eyeColor, _svgParams.eyeSize, _svgParams.pupilSize),
                    MouthDetail.buildMouth(_svgParams.mouth),
        ...
        return string(
            abi.encodePacked(
                generateSVGHead(),
                BodyDetail.buildBody(_svgParams.bodyId, _svgParams.bodyColor),
                EyesDetail.buildLeftEye(_svgParams.eyeColor, _svgParams.eyeSize, _svgParams.pupilSize),
                EyesDetail.buildRightEye(_svgParams.eyeColor, _svgParams.eyeSize, _svgParams.pupilSize),
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    abi.encodePacked(
                        getJsonAttribute("Color", _svgParams.bodyColor, false),
                        getJsonAttribute("Sclera Color", _svgParams.eyeColor, false),
